package com.scouter.monsterfood.common.crafting;
...
public class ChanceResult
{
    ...
    public ItemStack rollOutput(Random rand, int fortuneLevel) {
        ...
        double fortuneBonus = 1 * fortuneLevel;
        ...
        if (GsonHelper.isValidPrimitive(json, "nbt")) {
            try {
                ...
                itemstack.setTag(TagParser.parseTag(
                        element.isJsonObject() ? MonsterFood.GSON.toJson(element) : GsonHelper.convertToString(element, "nbt")));
            }
