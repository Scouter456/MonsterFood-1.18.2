...
import com.scouter.monsterfood.common.crafting.ChanceResult;
...
public class CuttingBoardRecipe implements Recipe<RecipeWrapper> {
    public static RecipeType<CuttingBoardRecipe> TYPE = RecipeType.register(MonsterFood.MODID + ":cutting");
    ...
    private static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<CuttingBoardRecipe> {
        Serializer() {
            this.setRegistryName(prefix("cutting"));
        }
