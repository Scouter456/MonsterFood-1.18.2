...
public class MFConfiguredFeatures {
    ...
    public static final RegistryObject<ConfiguredFeature<?,?>> CONFIGURED_NIGHTMARE_COLONY = CONFIGURED_FEATURES.register(NIGHTMARE_COLONY_NAME, new ConfiguredFeature<>(MFFeatures.NIGHTMARE_COLONY.get(), new CountConfiguration(6)));
