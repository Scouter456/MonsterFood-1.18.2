...
public class NightmareFeature extends Feature<CountConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<CountConfiguration> pContext) {
        ...
        for(int k = 0; k < j; ++k) {
            ...
            BlockState blockstate = MFBlocks.NIGHTMARE.get().defaultBlockState().setValue(NightmareBlock.NIGHTMARES, Integer.valueOf(random.nextInt(4) + 1)).setValue(NightmareBlock.WATERLOGGED, Boolean.valueOf(false));
