...
public class MFBlocks {
    ...
    public static final RegistryObject<Block> SKILLET = BLOCKS.register("skillet", () -> new SkilletBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).randomTicks().noOcclusion(), MFBlockEnums.raw));
    public static final RegistryObject<Block> RAW_WALKING_MUSHROOM_GARLIC_BUTTER_SKILLET = BLOCKS.register("raw_walking_mushroom_garlic_butter_skillet", () -> new MushroomGarlicButterSkillet(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).randomTicks().noOcclusion(), MFBlockEnums.raw));

    public static final RegistryObject<Block> COOKED_WALKING_MUSHROOM_GARLIC_BUTTER_SKILLET = BLOCKS.register("cooked_walking_mushroom_garlic_butter_skillet", () -> new MushroomGarlicButterSkillet(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).randomTicks().noOcclusion(), MFBlockEnums.cooked));
